...
from tutor_assistant.core import LessonCalendarProvider
from tutor_assistant.core.calendar import CalendarLessonEvent
from tutor_assistant.daily_summary.models import LatestNotesPdf
from tutor_assistant.daily_summary.providers import (
...
class HomeworkService:
    ...
    def upload_homework_for_day(self, *, target_date: date) -> HomeworkUploadResult:
        ...
        raise RuntimeError(
            ...
            "asyncio. Uzyj await upload_homework_for_day_async(...)."
        )
